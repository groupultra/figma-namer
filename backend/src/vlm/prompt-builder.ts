// ============================================================
// Figma Namer - Server-side Prompt Builder
// Constructs structured XML prompts for VLM naming requests
// ============================================================
...
// ---- CESPC Naming Framework Definition ----
    ...
    .map((s) => {
      ...
      if (propEntries.length > 0) {
        const propStr = propEntries
          ...
          .join(', ');
        parts.push(`      <component-properties>${propStr}</component-properties>`);
      }
